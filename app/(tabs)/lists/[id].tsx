    ...
    return (
      <SafeAreaView style={styles.container}>
        ...
        <View style={styles.emptyContainer}>
          <Text variant="bodyLarge">Diese Liste existiert nicht.</Text>
        </View>
      </SafeAreaView>
    );
  }
                ...
                {uncheckedItems.map(item => (
                  <View key={item.id} style={styles.itemContainer}>
                    ...
                    <View style={styles.itemText}>
                      ...
                      {(item.quantity !== '1' || item.unit !== Unit.PIECE) && (
              ...
              <>
                ...
                {checkedItems.map(item => (
                  <View key={item.id} style={styles.itemContainer}>
                    ...
                    />
                    <View style={styles.itemText}>
                      <Text variant="bodyLarge" style={styles.itemNameChecked}>
                        {item.name}
                      </Text>
                      {(item.quantity !== '1' || item.unit !== Unit.PIECE) && (
                        <View style={styles.itemMeta}>
        ...
        >
          ...
          <Dialog.Content>
            <Text variant="bodyMedium">
              Möchtest du alle {checkedItems.length} erledigten Artikel löschen?
            </Text>
          </Dialog.Content>
          <Dialog.Actions>
